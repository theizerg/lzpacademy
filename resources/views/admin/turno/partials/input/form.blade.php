  ...
  <div class="col-12">
    <label>Nombre del turno: </label>
      <div class="input-group input-group-merge mb-2">
       ...
       {!! Form::text('name',null,['class'=>'form-control', 'required' => 'required','autocomplete' =>'off','placeholder' =>'Nombre del turno']) !!}
    </div>
  </div>
 <div class="col-12 text-center">
    <label class="font-weight-bolder" for="status">Estado del turno</label>
