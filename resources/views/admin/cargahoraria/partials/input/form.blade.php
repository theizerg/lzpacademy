<div class="row">
  <div class="col-2"> 
   ...
   <div class="input-group input-group-merge mb-2">
       ...
       {!! Form::number('nu_orden',null,['class'=>'form-control', 'required' => 'required','autocomplete' =>'off','placeholder' =>'1']) !!}
    </div>
  </div>
    <input type="hidden" name="hora_academica_id" value="{{ $idHoraAcademica }}">
 <div class="col-5">
   ...
   <div class="input-group input-group-merge mb-2">
       ...
       {!! Form::time('hh_inicio',null,['class'=>'form-control  ', 'required' => 'required','autocomplete' =>'off','id' =>'pt-format','placeholder'=>'']) !!}
    </div>
 </div>
<div class="col-5">
   ...
   <div class="input-group input-group-merge mb-2">
       ...
       {!! Form::time('hh_fin',null,['class'=>'form-control  ', 'required' => 'required','autocomplete' =>'off','id' =>'pt-format','placeholder'=>'']) !!}
    </div>
 </div>
  <div class="col-12">
   ...
   <div class="input-group input-group-merge mb-2">
       ...
       {!! Form::text('nb_carga_horaria',null,['class'=>'form-control', 'required' => 'required','autocomplete' =>'off','placeholder' =>'Orden del periodo']) !!}
    </div>
  </div>
 @php
...
@endphp
 <div class="col-6">
  ...
  <div class="col-6">
    <label>¿Hora de receso? </label>
     <div class="input-group input-group-merge mb-2">
        <div class="checkbox icheck">
      <label class="font-weight-bolder">
        <input type="radio" name="bo_receso" value="1" checked> Si&nbsp;&nbsp;
        <input type="radio" name="bo_receso" value="0"> No
      </label>
    </div>
  ...
  <div class="col-12 text-center">
    <label class="font-weight-bolder" for="status">Estado de la carga horaria</label>
    <div class="checkbox icheck">
      <label class="font-weight-bolder">
