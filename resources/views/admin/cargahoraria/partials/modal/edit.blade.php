  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Editar datos del aula</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
       {!! Form::model($element, ['route' => ['cargahoraria.update',$element->id],'method' => 'PUT','enctype'=>'multipart/form-data']) !!}
        @include('admin.cargahoraria.partials.input.form')
        <br><br>
