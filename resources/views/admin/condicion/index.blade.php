...
@section('content')
    ...
    <div class="col-lg-12">
      <div class="card card-line-primary">
            <div class="card-header">
              <h4 class="card-title">Listado de condición del alumnio</h4>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    @foreach ($academias as $element)
                      <tr>
                       ...
                       @include('admin.condicion.partials.modal.edit')
                    @endforeach
                  </tbody>
                </table>
            </div>
  ...
  @include('admin.condicion.partials.modal.create')
